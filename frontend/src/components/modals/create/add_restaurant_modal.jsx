...
const ADD_RESTAURANT = "http://localhost:8000/api/view/add_restaurant/";
    ...
    axios({
      ...
      .then((res) => {
        window.location.href =
          "/data_management/restaurant/" + res.data.new_restaurant_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
      ...
      >
        ...
        <Modal.Footer>
          <small className="mr-auto">
            ...
            />
            All fields except Tel2 and Tel3 are required to create a restaurant.
            {Name.length < 2 ||
            Address.length < 5 ||
            !tel ||
