...
const ADD_CRUISING_COMPANY = "http://localhost:8000/api/view/add_cruising_company/";
...
function AddCruisingCompanyModal() {
  ...
  const createNewCruisingCompany = () => {
    axios({
      method: "post",
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_cruising_company_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Cruising Company </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddCruisingCompanyModal;
