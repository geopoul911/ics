...
const ADD_FERRY_TICKET_AGENCY =
  "http://localhost:8000/api/view/add_ferry_ticket_agency/";
...
function AddFerryTicketAgencyModal(props) {
  ...
  const createNewFerryTicketAgency = () => {
    axios({
      method: "post",
      ...
      .then((res) => {
        if (props.redir) {
          window.location.href =
            ...
            res.data.new_ferry_ticket_agency_id;
        } else {
          props.set_ferry_ticket_agency(Name);
        }
      })
      .catch((e) => {
        Swal.fire({
  ...
  return (
    <>
      ...
      >
        ...
        />
        Create new Ferry Ticket Agency
      </Button>
      <Modal
        show={show}
        size="lg"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Ferry Ticket Agency </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddFerryTicketAgencyModal;
