...
const ADD_TRAIN_TICKET_AGENCY =
  "http://localhost:8000/api/view/add_train_ticket_agency/";
...
function AddTrainTicketAgencyModal(props) {
  ...
  const createNewTrainTicketAgency = () => {
    axios({
      method: "post",
      ...
      .then((res) => {
        if (props.redir) {
          window.location.href =
            ...
            res.data.new_train_ticket_agency_id;
        } else {
          props.set_train_ticket_agency(Name);
        }
      })
      .catch((e) => {
        Swal.fire({
  ...
  return (
    <>
      ...
      >
        ...
        />
        Create new Train Ticket Agency
      </Button>
      <Modal
        show={show}
        size="lg"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Train Ticket Agency </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <small className="mr-auto">
            ...
            />
            All fields except Tel2, Tel3 and website are required to create a
            Train Ticket Agency.
            {Name.length < 2 ||
            Address.length < 5 ||
            !tel ||
...
export default AddTrainTicketAgencyModal;
