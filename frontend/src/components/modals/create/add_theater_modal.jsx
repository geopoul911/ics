...
const ADD_THEATER = "http://localhost:8000/api/view/add_theater/";
...
function AddTheaterModal(props) {
    ...
    axios({
      ...
      .then((res) => {
        window.location.href =
          "/data_management/theater/" + res.data.new_theater_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Theater </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <small className="mr-auto">
            ...
            />
            All fields except Tel2 and Tel3 are required to create a theater.
            {Name.length < 2 ||
            Address.length < 5 ||
            !tel ||
