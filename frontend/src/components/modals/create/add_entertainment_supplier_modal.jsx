...
const ADD_ENTERTAINMENT_SUPPLIER = "http://localhost:8000/api/view/add_entertainment_supplier/";
...
function AddEntertainmentSupplierModal() {
  ...
  const createNewEntertainmentSupplier = () => {
    axios({
      method: "post",
      url: ADD_ENTERTAINMENT_SUPPLIER,
      headers: headers,
      data: {
        name: Name,
        address: Address,
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_entertainment_supplier_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
  ...
  const getCities = () => {
    axios.get(GET_CITIES, {headers: headers,})
      .then((res) => {
  ...
  return (
    <>
      ...
      >
        ...
        Create new Shows & Entertainment Supplier
      </Button>
      <Modal
        show={show}
        size="lg"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Shows & Entertainment Supplier </Modal.Title>
        </Modal.Header>
        <Modal.Body>
              ...
              <Form>
                <Form.Group>
                  ...
                  <Form.Control
                    maxLength="63"
                    style={{ width: 400 }}
                    onChange={(e) => setName(allowAlpha(e.target.value.toUpperCase()))}
                    value={Name}
                  />
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() => {
              handleClose();
              createNewEntertainmentSupplier();
            }}
            disabled={
              Name.length < 2 ||
              Address.length < 5 ||
...
export default AddEntertainmentSupplierModal;
