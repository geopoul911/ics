...
const ADD_CHARTER_BROKER = "http://localhost:8000/api/view/add_charter_broker/";
...
function AddCharterBrokerModal() {
    ...
    axios({
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_charter_broker_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Charter Broker </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddCharterBrokerModal;
