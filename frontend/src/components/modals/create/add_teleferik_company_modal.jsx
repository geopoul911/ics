...
const ADD_TELEFERIK_COMPANY =
  "http://localhost:8000/api/view/add_teleferik_company/";
...
function AddTeleferikCompanyModal() {
  ...
  const createNewTeleferikCompany = () => {
    axios({
      method: "post",
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_teleferik_company_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Teleferik Company </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddTeleferikCompanyModal;
