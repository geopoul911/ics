...
const ADD_GROUND_HANDLING_COMPANY = "http://localhost:8000/api/view/add_dmc/";
...
function AddDMCModal() {
  ...
  const createNewDMC = () => {
    axios({
      method: "post",
      url: ADD_GROUND_HANDLING_COMPANY,
      headers: headers,
      data: {
        name: Name,
        address: Address,
      ...
      .then((res) => {
        window.location.href = "/data_management/dmc/" + res.data.new_dmc_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new DMC </Modal.Title>
        </Modal.Header>
        <Modal.Body>
