...
const ADD_SPORT_EVENT_SUPPLIER =
  "http://localhost:8000/api/view/add_sport_event_supplier/";
...
function AddSportEventSupplierModal() {
  ...
  const createNewSportEventSupplier = () => {
    axios({
      method: "post",
      url: ADD_SPORT_EVENT_SUPPLIER,
      headers: headers,
      data: {
        name: Name,
        address: Address,
      ...
      .then((res) => {
        window.location.href =
          "/data_management/sport_event_supplier/" +
          res.data.new_sport_event_supplier_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
  ...
  return (
    <>
      ...
      >
        ...
        />
        Create new Sport Event Supplier
      </Button>
      <Modal
        show={show}
        size="lg"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Sport Event Supplier </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddSportEventSupplierModal;
