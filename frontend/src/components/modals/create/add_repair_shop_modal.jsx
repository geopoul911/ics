...
const ADD_REPAIR_SHOP = "http://localhost:8000/api/view/add_repair_shop/";
...
function AddRepairShopModal(props) {
    ...
    axios({
      ...
      .then((res) => {
        window.location.href =
          "/data_management/repair_shop/" + res.data.new_repair_shop_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new repair shop </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <small className="mr-auto">
            ...
            />
            All fields except Tel2 and Tel3 are required to create a repair
            shop.
            {Name.length < 2 ||
            Address.length < 5 ||
            !tel ||
...
export default AddRepairShopModal;
