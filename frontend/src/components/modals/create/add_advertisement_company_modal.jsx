...
const ADD_ADVERTISEMENT_COMPANY =
  "http://localhost:8000/api/view/add_advertisement_company/";
...
function AddAdvertisementCompanyModal() {
  ...
  const createNewAdvertisementCompany = () => {
    axios({
      method: "post",
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_advertisement_company_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
  ...
  return (
    <>
      ...
      >
        ...
        />
        Create new Advertisement Company
      </Button>
      <Modal
        show={show}
        size="lg"
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Advertisement Company </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddAdvertisementCompanyModal;
