...
const ADD_CAR_HIRE_COMPANY =
  "http://localhost:8000/api/view/add_car_hire_company/";
...
function AddCarHireCompanyModal() {
    ...
    axios({
      ...
      .then((res) => {
        window.location.href =
          ...
          res.data.new_car_hire_company_id;
      })
      .catch((e) => {
        Swal.fire({
          icon: "error",
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new Car Hire Company </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default AddCarHireCompanyModal;
