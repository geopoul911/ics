...
const ADD_LEADER = "http://localhost:8000/api/view/add_group_leader/";
...
function AddGroupLeaderModal(props) {
      ...
      .then((res) => {
        if (props.redir) {
          window.location.href =
            "/data_management/group_leader/" + res.data.new_group_leader_id;
        } else {
          props.set_leader(Name);
        }
      })
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title> Create new group leader </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <small className="mr-auto">
            ...
            />
            All fields except Tel2 and Tel3 are required to create a group
            leader.
            {Name.length < 2 ||
            !tel ||
