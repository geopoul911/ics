...
const DELETE_ENDPOINTS = {
  'Country': 'https://ultima.icsgr.com/api/regions/country/',
  'Province': 'https://ultima.icsgr.com/api/regions/province/',
  'City': 'https://ultima.icsgr.com/api/regions/city/',
  'User': 'https://ultima.icsgr.com/api/site_admin/del_usr/',
  'Consultant': 'https://ultima.icsgr.com/api/administration/consultant/',
  'Bank': 'https://ultima.icsgr.com/api/administration/bank/',
  'InsuranceCarrier': 'https://ultima.icsgr.com/api/administration/insurance_carrier/',
  'Profession': 'https://ultima.icsgr.com/api/administration/profession/',
  'ProjectCategory': 'https://ultima.icsgr.com/api/administration/project_category/',
  'TaskCategory': 'https://ultima.icsgr.com/api/administration/task_category/',
  'Document': 'https://ultima.icsgr.com/api/data_management/document/',
  'Client': 'https://ultima.icsgr.com/api/data_management/client/',
  'ClientContact': 'https://ultima.icsgr.com/api/data_management/client_contact/',
  'BankClientAccount': 'https://ultima.icsgr.com/api/data_management/bank_client_account/',
  'BankProjectAccount': 'https://ultima.icsgr.com/api/data_management/bank_project_account/',
  'Project': 'https://ultima.icsgr.com/api/data_management/project/',
  'AssociatedClient': 'https://ultima.icsgr.com/api/data_management/associated_client/',
  'TaskComment': 'https://ultima.icsgr.com/api/data_management/task_comment/',
  'Property': 'https://ultima.icsgr.com/api/data_management/property/',
  'ProjectTask': 'https://ultima.icsgr.com/api/data_management/project_task/',
  'Cash': 'https://ultima.icsgr.com/api/data_management/cash/',
  'Professional': 'https://ultima.icsgr.com/api/data_management/professional/',
  'TaxationProject': 'https://ultima.icsgr.com/api/data_management/taxation_project/',
