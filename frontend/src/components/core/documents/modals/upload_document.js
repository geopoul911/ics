...
const ADD_DOCUMENT = "http://localhost:8000/api/data_management/upload_document/";
    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Add a new document for {props.object_type} {getRefcode(window.location.pathname)}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
