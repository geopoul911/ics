...
const ProfessionDetail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire('Error', 'Failed to save profession', 'error');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        Swal.fire('Error', 'Failed to delete profession', 'error');
      } finally {
        setIsLoading(false);
      }
    }
  ...
  return (
    <div className="container-fluid">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h2>
          {isCreating ? 'New Profession' : 'Profession Details'}
        </h2>
        <div>
          {!isCreating && (
            <>
          ...
          <Button
            variant="secondary"
            onClick={() => history.push('/data_management/professions')}
          >
            Back to List
          </Button>
        </div>
