...
const VIEW_ENTERTAINMENT_SUPPLIER =
  "http://localhost:8000/api/data_management/entertainment_supplier/";
...
class EntertainmentSupplierOverView extends React.Component {
    ...
    axios
      ...
      .then((res) => {
        this.setState({
          ...
          contact_persons: res.data.entertainment_supplier.contact_persons,
          is_loaded: true,
        });
      })
      .catch((e) => {
  ...
  update_entertainment_supplier = (entertainment_supplier) => {
    this.setState({ entertainment_supplier: entertainment_supplier });
  };

  add_contact_person = (contact_persons) => {
    var entertainment_supplier = { ...this.state.entertainment_supplier };
    entertainment_supplier.contact_persons = contact_persons;
    this.setState({
  ...
  update_notes = (notes) => {
    var entertainment_supplier = { ...this.state.entertainment_supplier };
    entertainment_supplier.notes = notes;
    this.setState({
      entertainment_supplier: entertainment_supplier,
    });
  };
    ...
    return (
      <>
        <div className="mainContainer">
          {pageHeader(
            "entertainment_supplier_overview",
            this.state.entertainment_supplier.name
          )}
                  ...
                  <Grid.Column>
                    <Card>
                      ...
                      <Card.Body>
                        ...
                        <ChangeName
                          object_id={this.state.entertainment_supplier.id}
                          object_name={this.state.entertainment_supplier.name}
                      ...
                      <div className={"info_span"}>
                        {this.state.entertainment_supplier.payment_details
                          ? this.state.entertainment_supplier.payment_details.company === "" ||
                            this.state.entertainment_supplier.payment_details.company === null
                            ? "N/A"
                            : 
                            <span style={{color: this.state.entertainment_supplier.payment_details.company === this.state.entertainment_supplier.name ? 'blue': ''}}>
                              {this.state.entertainment_supplier.payment_details.company}
                            </span>
                          : "N/A"}
                      </div>
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.contact.address
                            ? this.state.entertainment_supplier.contact.address
                            : "N/A"}
                        </div>
                        <ChangeAddress
                        ...
                        {this.state.show_address2 ? (
                          <>
                            ...
                            <div className={"info_span"}>
                              {this.state.entertainment_supplier.contact.address2
                                ? this.state.entertainment_supplier.contact
                                    .address2
                                : "N/A"}
                            </div>
                            <FaMinus
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.contact.tel
                            ? this.state.entertainment_supplier.contact.tel
                            : "N/A"}
                        </div>
                        <ChangeTel
                        ...
                        {this.state.show_tel2 ? (
                          <>
                            ...
                            <div className={"info_span"}>
                              {this.state.entertainment_supplier.contact.tel2
                                ? this.state.entertainment_supplier.contact.tel2
                                : "N/A"}
                            </div>
                            ...
                            <div className={"info_span"}>
                              {this.state.entertainment_supplier.contact.tel3
                                ? this.state.entertainment_supplier.contact.tel3
                                : "N/A"}
                            </div>
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.region ? this.state.entertainment_supplier.region : 'N/A'}
                        </div>
                        ...
                        <ChangeRegion
                          ...
                          object_type={"Entertainment Supplier"}
                          update_state={this.update_state}
                          region_id={this.state.entertainment_supplier.region_id}
                          region_type={
                            this.state.entertainment_supplier.region_type
                          }
                        />
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.contact.postal
                            ? this.state.entertainment_supplier.contact.postal
                            : "N/A"}
                        </div>
                        <ChangePostal
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.contact.email
                            ? this.state.entertainment_supplier.contact.email
                            : "N/A"}
                        </div>
                        <ChangeEmail
                        ...
                        <div className={"info_span"}>
                          {this.state.entertainment_supplier.contact.website
                            ? this.state.entertainment_supplier.contact.website
                            : "N/A"}
                        </div>
                        <ChangeWebsite
                        ...
                        <ChangeLatLng
                          ...
                          object_type={"Entertainment Supplier"}
                          update_state={this.update_state}
                          lat={this.state.entertainment_supplier.lat}
                          lng={this.state.entertainment_supplier.lng}
                        />
                        <div className={"lat_lng_span"}>
                          {this.state.entertainment_supplier.lat
                            ? this.state.entertainment_supplier.lat
                            : "N/A"}
                        </div>
                        <div
                        ...
                        >
                          {this.state.entertainment_supplier.lng
                            ? this.state.entertainment_supplier.lng
                            : "N/A"}
                        </div>
                        <ContactPersons
                          ...
                          update_state={this.update_state}
                          contact_persons={
                            this.state.entertainment_supplier.contact_persons
                          }
                        />
                        <div className={"info_descr"}>
                          {this.state.entertainment_supplier.enabled ? (
                    ...
                    <Notes
                      ...
                      object_type={"Entertainment Supplier"}
                      update_state={this.update_state}
                      notes={this.state.entertainment_supplier.notes}
                    />
                  ...
                  <Grid.Column>
                    <Card>
                      <Card.Header>
                        ...
                        />
                        Map with Entertainment Supplier's location
                      </Card.Header>
                      {this.state.entertainment_supplier.lat ||
                      this.state.entertainment_supplier.lng ? (
                        <>
                        ...
                        >
                          ...
                          entertainment_supplier\'s location on map
                        </strong>
                      )}
                      <Card.Footer>
                        <small className="mr-auto">
                          ...
                          />
                          Changing entertainment_supplier's lat/lng will also
