...
// Variables
const VIEW_CLIENT = "http://localhost:8000/api/data_management/hotel/";
    ...
    return (
      <>
        <div className="mainContainer">
          {pageHeader("hotel_groups", this.state.hotel.name)}
          {this.state.forbidden ? (
            <>
              {forbidden("Hotel Groups")}
            </>
