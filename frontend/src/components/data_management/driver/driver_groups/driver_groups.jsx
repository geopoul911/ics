...
// Variables
const VIEW_CLIENT = "http://localhost:8000/api/data_management/driver/";
    ...
    return (
      <>
        <div className="mainContainer">
          {pageHeader("driver_groups", this.state.driver.name)}
          {this.state.forbidden ? (
            <>
              {forbidden("Driver Groups")}
            </>
