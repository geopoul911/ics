...
const ProfessionalDetail = () => {
  ...
  const loadProfessional = useCallback(async () => {
    ...
    try {
      ...
      if (professional.country) {
        await loadProvinces(professional.country);
        if (professional.province) {
          await loadCities(professional.province);
        }
      }
    } catch (error) {
      console.error('Error loading professional:', error);
      Swal.fire('Error', 'Failed to load professional', 'error');
  ...
  useEffect(() => {
    ...
    initialize();
  }, [id, history, loadReferenceData, loadProfessional]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire('Error', 'Failed to save professional', 'error');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="container-fluid">
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h2>
          {isCreating ? 'New Professional' : 'Professional Details'}
        </h2>
        <div>
          {!isCreating && (
            <>
          ...
          <Button
            variant="secondary"
            onClick={() => history.push('/data_management/professionals')}
          >
            Back to List
          </Button>
        </div>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                disabled={!isEditing}
                placeholder="Professional specializations, certifications, etc."
              />
            </Form.Group>
