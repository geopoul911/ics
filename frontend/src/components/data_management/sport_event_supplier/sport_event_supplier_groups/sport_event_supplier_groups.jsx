...
class SportEventSupplierGroups extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      groups: [],
    ...
    return (
      <>
        <div className="mainContainer">
          {pageHeader("sport_event_supplier_groups", this.state.sport_event_supplier.name)}
          {this.state.forbidden ? (
            <>
              {forbidden("Sport Event Supplier Groups")}
            </>
...
export default SportEventSupplierGroups;
